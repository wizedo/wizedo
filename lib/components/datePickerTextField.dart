...
class _DateSelectorState extends State<DateSelector> {
  Future<void> _selectYear(BuildContext context) async {
    ...
    DateTime next2Months = currentDate.add(const Duration(days: 60)); // Add 60 days for the next 2 months
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintStyle: const TextStyle(color: Colors.white, fontWeight: FontWeight.normal, fontSize: 13),

...
class MyPostTextField extends StatefulWidget {
  ...
  @override
  _MyPostTextFieldState createState() => _MyPostTextFieldState();
}

class _MyPostTextFieldState extends State<MyPostTextField> {
  String? errorMessage;

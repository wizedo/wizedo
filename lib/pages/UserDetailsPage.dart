...
class _UserDetailsState extends State<UserDetails> {
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((prefs) {
      bool userDetailsSubmitted = prefs.getBool('userDetailsSubmitted') ?? false;
      // Update isFinished based on whether user details are submitted
      setState(() {
        isFinished = userDetailsSubmitted;
      });
    });
  }
                  ...
                  child: Container(
                    ...
                    child: SwipeableButtonView(
                      onFinish: () async {
                        ...
                        // Store the information that user details are submitted
                        prefs.setBool('userDetailsSubmitted', true);
                      },
